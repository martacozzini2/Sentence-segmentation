...
The file output_corpus_no_ricette.txt was manually created from the file `output_corpus_in_frasi.txt`, that is the output of the script called `corpus_in_frasi_dueparole.py` that you can find on the preprocessing folder. The file `output_corpus_no_ricette.txt` is used in the script `dataframe_dueparole.py` to create the dataframe to train the decision Tree.
